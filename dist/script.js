...
/* harmony import */ var _modules_imageHover__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/imageHover */ "./src/js/modules/imageHover.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_4__["default"])('.button-styles', '.styles-2', '.styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_5__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', calcData);
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_imageHover__WEBPACK_IMPORTED_MODULE_7__["default"])('.sizes-block');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calculator = function calculator(size, material, options, promocode, price, calcData) {
  var sizeBlock = document.querySelector(size),
      materialBlock = document.querySelector(material),
      optionsBlock = document.querySelector(options),
      promocodeBlock = document.querySelector(promocode),
      priceBlock = document.querySelector(price);
  var sum = 0; // function updateObject(selector, key, data) {
  // }

  var calcPrice = function calcPrice() {
    switch (sizeBlock.value) {
      case '1000':
        calcData.sizeBlock = '40x50';
        break;

      case '1500':
        calcData.sizeBlock = '50x70';
        break;

      case '2000':
        calcData.sizeBlock = '70x70';
        break;

      case '2500':
        calcData.sizeBlock = '70x100';
        break;
    }

    switch (materialBlock.value) {
      case '1':
        calcData.materialBlock = 'Холст из волокна';
        break;

      case '1.2':
        calcData.materialBlock = 'Льняной холст';
        break;

      case '1.7':
        calcData.materialBlock = 'Холст из натурального хлопка';
        break;
    }

    switch (optionsBlock.value) {
      case '500':
        calcData.optionsBlock = 'Покрытие арт-гелем';
        break;

      case '1000':
        calcData.optionsBlock = 'Экспресс-изготовление';
        break;

      case '800':
        calcData.optionsBlock = 'Доставка готовых работ';
        break;
    }

    promocodeBlock.value == 'IWANTPOPART' ? calcData.promocode = true : calcData.promocode = false;
    sum = Math.round(+sizeBlock.value * +materialBlock.value + +optionsBlock.value); // console.log(sum);
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      ...
      priceBlock.textContent = "".concat(sum);
...
var filter = function filter() {
  var btnsMenu = document.querySelector('.portfolio-menu'),
...
function forms(calcData) {
  var forms = document.querySelectorAll('form'),
      ...
      upload = document.querySelectorAll('[name="upload"]'); // onlyNumbers('input[name="user_phone"]');
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      var result = arr[0].substring(0, 6) + dots + arr[1];
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      console.log(api);
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, data).then(function (response) {
...
var imageHover = function imageHover(blocks) {
  var sizeBlocks = document.querySelectorAll(blocks);
  ...
  sizeBlocks.forEach(function (block) {
    block.addEventListener('mouseover', function () {
      return showBlock(block);
    });
    block.addEventListener('mouseout', function () {
      return hideBlock(block);
    });
  });
};
...
var modal = function modal() {
  ...
  function modalTrigger(buttonSelector, modalSelector, closeButtonSelector) {
    var deleteTrigger = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var buttonsModal = document.querySelectorAll(buttonSelector),
  ...
  modalTrigger('.fixed-gift', '.popup-gift', '.popup-close', true); // showModalByTime('.popup-consultation', 5000);
};
...
var showMoreStyles = function showMoreStyles(triggerSelector, cardsSelector, wrapperSelector) {
  var btn = document.querySelector(triggerSelector),
      cards = document.querySelectorAll(cardsSelector),
      wrapper = document.querySelector(wrapperSelector); //version without the server - commented out
  // cards.forEach(card => {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["requestData"])('http://localhost:3000/styles').then(function (res) {
...
var sliders = function sliders(slidesSelector, dir, prevArrow, nextArrow) {
  ...
  slides[slideCounter].style.display = 'block'; //slider on repeat + stops when mouse enters the parent div's zone
  ...
  slides.forEach(function (slide) {
    slide.parentNode.addEventListener('mouseenter', function () {
      clearInterval(timer);
      timer = null;
    });
    slide.parentNode.addEventListener('mouseleave', function () {
      // if (!timer) {
      clearInterval(timer);
      timer = null;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Something went wrong at the url:".concat(url, ", status:").concat(response.status));
